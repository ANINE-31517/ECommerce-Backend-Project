    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/category/customers/**").hasAuthority("CUSTOMER")
                        .requestMatchers("/api/category/sellers/**").hasAuthority("SELLER")
                        .requestMatchers("/api/category/admin/**").hasAuthority("ADMIN")
